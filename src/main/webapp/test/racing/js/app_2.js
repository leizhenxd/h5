...
function initStartScreen() {
    ...
    userInput.addHitArea("showMapScreen", butEventHandler, null, "image", a),//showMapScreen
...
function chooseCar() {
    ...
    var c = new Array(a,b);
    userInput.addHitArea("chooseA", butEventHandler, null, "image", a);
    userInput.addHitArea("chooseB", butEventHandler, null, "image", b);
    panel = new Elements.Panel(assetLib.getData("panels"), assetLib.getData("uiElements"), assetLib.getData("position"), assetLib.getData("numbers"), gameState, c, canvas.width, canvas.height),
        panel.startTween1(),
        previousTime = (new Date).getTime(),
        updateStartScreenEvent()
...
function butEventHandler(a, b) {
    switch (a) {
        ...
        case"chooseA":
            playSound("click"),
                 userInput.removeHitArea("chooseA"),
                 userInput.removeHitArea("chooseB"),
                 userInput.removeHitArea("moreGames"),
                userCar = new Elements.UserCar(assetLib.getData("userCar"), canvas.width, canvas.height),
                // userInput.removeHitArea("credits"),
                initMapScreen();
        ...
        case"chooseB":
            playSound("click"),
                ...
                userInput.removeHitArea("chooseB"),
                userInput.removeHitArea("moreGames"),
                userCar = new Elements.UserCar(assetLib.getData("userCarB"), canvas.width, canvas.height),
                // userInput.removeHitArea("credits"),
                initMapScreen();
            break;
        case "credits":
...
function loadAssets() {
    assetLib = new Utils.AssetLoader(curLang, [{
        ...
        {
            id: "userCarB",
            file: "images/userCar_1_122x82.png"
        },
        {
            id: "enemyCar",
