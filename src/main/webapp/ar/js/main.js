...
if( true ){
	...
	if( !navigator.getUserMedia )	{alert("error1");throw new Error("navigator.getUserMedia not found.");}
	if( !window.URL )		{alert("error2");throw new Error("window.URL not found.");}
	if(!window.URL.createObjectURL)	{alert("error3");throw new Error("window.URL.createObjectURL not found.");}
